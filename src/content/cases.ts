...
export const CASES_UI = {
  es: {
    ...
    indexTitle: 'Tres casos, tres decisiones difíciles',
    indexLede: 'Cada uno arranca en un encargo y termina en una métrica. Elige por dónde entrar: cada caso vive en su propia página.',
  ...
  en: {
    ...
    indexTitle: 'Three cases, three hard decisions',
    indexLede: 'Each one starts as a brief and ends in a metric. Pick where to go in: every case lives on its own page.',
