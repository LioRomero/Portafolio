...
export const CASES_UI = {
  es: {
    ...
    howItTurnedOut: 'Cómo quedó',
    nextCase: 'Siguiente caso',
    letsTalk: 'Hablemos',
    backHome: 'Volver al inicio',
    evOpen: 'Ver la evidencia',
    ...
    keys: [['Cambiar de modo de lectura', 'E'], ['Cambiar de idioma', 'L'], ['Pausar el movimiento', 'M'], ['Modo investigador', 'R'], ['Cerrar', 'Esc']],
  },
  en: {
    ...
    howItTurnedOut: 'How it turned out',
    nextCase: 'Next case',
    letsTalk: "Let's talk",
    backHome: 'Back to home',
    evOpen: 'See the evidence',
    ...
    keys: [['Switch reading mode', 'E'], ['Switch language', 'L'], ['Pause motion', 'M'], ['Researcher mode', 'R'], ['Close', 'Esc']],
  },
} as const;
